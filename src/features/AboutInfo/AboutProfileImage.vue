<template>
  <SwiperWrapper>
    <div class="text-center text-4xl underline z-40 p-4 mb-5 bg-pale-violet w-1/3 mx-auto border-4 rounded-xl border-black shadow-neo">It's me</div>
    <SwiperSlide v-for="image in profileImages">
